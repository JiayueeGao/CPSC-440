CPSC 440/540 (FA24) Labs
==================

Git repository for labs in [CPSC 440/540][labs-github].

We will be using git, a source code control tool, to distribute labs in
CPSC 440/540. This will allow you to incrementally download the code for the
...
download and upload CPSC 440/540 labs via GitHub.
...
- [CPSC 440/540 (FA24) Labs](#cpsc-440540-fa24-labs)
  - [Contents](#contents)
...
1. The first thing we have to do is to clone the current lab repository by issuing the following commands on the command line:
   ...
   ```bash
    $ git clone https://github.com/yale-systems/CPSC-440-FA24.git
   ```
...
3. By default the remote called `origin` is set to the location that you cloned the repository from. You should see the following:
   ...
   ```bash
    $ git remote -v
        origin https://github.com/yale-systems/CPSC-440-FA24.git (fetch)
        origin https://github.com/yale-systems/CPSC-440-FA24.git (push)
   ```
   ...
   ```bash
    $ git remote -v
        upstream https://github.com/yale-systems/CPSC-440-FA24.git (fetch)
        upstream https://github.com/yale-systems/CPSC-440-FA24.git (push)
   ```
...
1. All new lab and previous lab solutions will be posted to the [labs repository][labs-github] in the class organization.
   ...
   Check it periodically as well as Canvas' announcements for updates on when the new labs are released.
...
invited to the class instance; if not, please check Canvas for an invite code.
...
Their contact information can be found on the course homepage.
...
[labs-github]: https://github.com/yale-systems/CPSC-440-FA24.git
