...
Petrov](https://learning.oreilly.com/library/view/database-internals/9781492040330/),
which provides detailed information about the structure of B+ trees. Accessing the
online version of this book is straightforward; you can log in to the O'Reilly
website with your Yale.edu account.
...
merge (see Figure 4). 
<!-- You may find it useful to review section 10.6 in the textbook. -->
...
Attempting to delete a tuple from a leaf page that
...
it's **not** required. Please note that this test may take up to a minute to complete.
...
called `lab4-writeup.txt` with your submission. You also need to explicitly add
